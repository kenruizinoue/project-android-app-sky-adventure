...
public class BookedAccomodationCardWidget extends ConstraintLayout {
    ...
    public BookedAccomodationCardWidget(@NonNull Context context) {
        super(context);
        init(context);
    }

    public BookedAccomodationCardWidget(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        rootView = inflate(context, R.layout.widget_booked_accomodation_card, this);
